    ...
    <footer className="bg-gray-900 mt-1">
      <div className="mx-auto px-4 sm:px-6 lg:px-16">
        <div className="lg:grid lg:grid-cols-1">
          <div className="">
            <div className="gap-20 mt-8 grid grid-cols-1 gap-4 sm:grid-cols-4">
              <div>
                <div className="hidden text-white dark:text-teal-300 lg:block">
                <Image src={Logo} width={140} height={100} />
                </div>
                <p className="text-white mt-5">
                سولسکیر نے مین یو ٹی ڈی کے پینلٹی ریکارڈ پر کلوپ کے تبصروں کو مسترد کردیا۔
                </p>
              ...
              <div>
                <p className="font-bold text-2xl text-white dark:text-white">
                فوٹو گیلری
                </p>
                <img
                  className="line-10"
                  alt="Line"
                  src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/line-23.svg"
                />
                <div className="photo-gallery">
                  <div className="flex gap-8 mt-6">
                    <img
                      className="image-9"
                      alt="Image"
                      src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/image-30.svg"
                    />
                    <img
                      className="image-10"
                      alt="Image"
                      src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/image-31.svg"
                    />
                    <img
                      className="image-11"
                      alt="Image"
                      src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/image-32.svg"
                    />
                  </div>
                  <div className="flex gap-8 mt-3">
                    <img
                      className="image-12"
                      alt="Image"
                      src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/image-33.svg"
                    />
                    <img
                      className="image-13"
                      alt="Image"
                      src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/image-34.svg"
                    />
                    <img
                      className="image-14"
                      alt="Image"
                      src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/image-35.svg"
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <img
                  ...
                  src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/line-23.svg"
                />
                <div className="photo-gallery mt-3">
                  <div className="flex gap-8 my-6">
                    ...
                    <Link href={"#"}>
                      <span className="bg-pink-600 text-white p-1">
                      کرکٹ
                      </span>
                    </Link>
                    <Link href={"#"}>
                      <span className="bg-yellow-600 text-white p-1">
                      بیڈمنٹن
                      </span>
                    </Link>
                  </div>
                ...
                <div className="mt-8 space-y-4 lg:mt-0">
                  <div>
                    ...
                    <img
                      ...
                      src="https://cdn.animaapp.com/projects/650436ea563939b650df9455/releases/650437a496d31c08b0a413c5/img/line-23.svg"
                    />
                    <p className="mt-4 max-w-lg text-white font-bold dark:text-gray-400">
                    سولسکیر نے مین یو ٹی ڈی کے پینلٹی ریکارڈ پر کلوپ کے
                    </p>
                  </div>
                  ...
                  <form className="mt-6 w-full">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border-none focus:border-transparent focus:ring-transparent dark:bg-gray-900 dark:text-white sm:text-sm p-3 mb-3"
                      />


                       <a
                      href="https://pakistaneyes.com//Urdu/News/[title].js/[id]" className="mt-1 w-full bg-red-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:shrink-0">
                      سبسکرائب
                      </a>
            ...
            <div className="mt-8 border-t border-gray-100 py-8 dark:border-gray-800 flex justify-center items-center">
              <ul className="flex flex-wrap gap-8 text-xs ">
                <li>
                  <a
                    href="#"
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                &copy; 2022 PakistanEyes_pk All rights reserved.
              </p>
            </div>
          </div>
        </div>
